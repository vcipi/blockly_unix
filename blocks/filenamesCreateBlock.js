/** DISCUSS WITH VAG. Παραμετροποίηση. Να μην είναι όλες οι functions
 *  σε όλα τα αρχεία αλλά να γίνεται import. Επίσης τα minus και plus images*/
  ...
  addPart_: function() {
    if (this.itemCount_ == 0) {
      ...
      this.topInput_ = this.appendValueInput('ADD' + this.itemCount_)
          ...
          .appendField(Blockly.Msg['FILES_CREATE_WITH']);
    } else {
  ...
  removePart_: function() {
    ...
    if (this.itemCount_ == 0) {
      this.topInput_ = this.appendDummyInput('EMPTY')
          .appendField(createPlusField(), 'PLUS')
          .appendField(Blockly.Msg['FILES_CREATE_EMPTY_TITLE']);
    }
  },
...
Blockly.Extensions.registerMutator('new_list_create_with_mutator_File',
    listCreateMutator_File, listCreateHelper_File);
