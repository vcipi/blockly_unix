...
Blockly.Blocks['lists_create_with_test'] = {
  /**
  ...
  init: function() {
    ...
    this.setMutator(new Blockly.icons.MutatorIcon(['lists_create_with_item']));
...
Blockly.Blocks['lists_create_with_container_test'] = {
  /**
